...
#include "inverseDistanceFringeCellCellStencil.H"
...
{
    defineTypeNameAndDebug(inverseDistanceFringe, 0);
    addToRunTimeSelectionTable(cellCellStencil, inverseDistanceFringe, mesh);
}
}

// * * * * * * * * * * * * * Private Member Functions  * * * * * * * * * * * //

Foam::label Foam::cellCellStencils::inverseDistanceFringe::index
(
...
Foam::labelVector Foam::cellCellStencils::inverseDistanceFringe::index3
(
    const labelVector& nDivs,
    const label boxI
)
...
Foam::point Foam::cellCellStencils::inverseDistanceFringe::position
(
    const boundBox& bb,
    const labelVector& nDivs,
    const label boxI
...
void Foam::cellCellStencils::inverseDistanceFringe::fill
(
    PackedList<2>& elems,
    const boundBox& bb,
    const labelVector& nDivs,
...
void Foam::cellCellStencils::inverseDistanceFringe::markBoundaries
(
    const fvMesh& mesh,
...
Foam::treeBoundBox Foam::cellCellStencils::inverseDistanceFringe::cellBb
(
...
bool Foam::cellCellStencils::inverseDistanceFringe::overlaps
(
    const boundBox& bb,
    const labelVector& nDivs,
...
void Foam::cellCellStencils::inverseDistanceFringe::markPatchesAsHoles
(
...
void Foam::cellCellStencils::inverseDistanceFringe::markDonors
(
...
void Foam::cellCellStencils::inverseDistanceFringe::findHoles
(
    const globalIndex& globalCells,
    const fvMesh& mesh,
...
void Foam::cellCellStencils::inverseDistanceFringe::seedCell
(
    const label cellI,
...
void Foam::cellCellStencils::inverseDistanceFringe::walkFront
(
...
void Foam::cellCellStencils::inverseDistanceFringe::stencilWeights
(
    const point& sample,
...
void Foam::cellCellStencils::inverseDistanceFringe::createStencil
(
    const globalIndex& globalCells
)
{
...
Foam::cellCellStencils::inverseDistanceFringe::inverseDistanceFringe
(
    const fvMesh& mesh,
...
bool Foam::cellCellStencils::inverseDistanceFringe::update()
{
